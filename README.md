...
### Full-Stack Software Engineer | React • Next.js • NestJS | Building Scalable, Sustainable Web Architectures

I am a Full-Stack Engineer dedicated to building **sustainable and lasting solutions**. My approach focuses on writing clean, maintainable code using the modern TypeScript ecosystem to ensure applications are not just functional today, but scalable for tomorrow. I am ready to collaborate and contribute my technical expertise to high-performing teams.
...
| **Backend** | NestJS, Node.js, Express.js, RESTful APIs |
| **Languages** | TypeScript, JavaScript (ES6+), SQL |
| **Infrastructure** | Git, Docker, CI/CD (GitHub Actions), Vercel |
...
## 🤝 Open to Work
I am currently seeking opportunities where I can contribute to building **sustainable, high-performance software**. As a Full-Stack Engineer, I don't just write code; I build solutions designed to last.
